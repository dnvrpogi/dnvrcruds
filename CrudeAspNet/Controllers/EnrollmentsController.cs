...
namespace CrudeAspNet.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        {
            ViewBag.Students = new SelectList(await _db.Students.OrderBy(student => student.StudentName).ToListAsync(), "Id", "StudentName");
            ViewBag.Courses = new SelectList(await _db.Courses.OrderBy(course => course.CourseCode).ToListAsync(), "Id", "CourseCode");
            ViewBag.SchoolYears = new SelectList(await _db.SchoolYears.OrderByDescending(year => year.SchoolYearCode).ToListAsync(), "Id", "SchoolYearCode");
        }
    }
}
